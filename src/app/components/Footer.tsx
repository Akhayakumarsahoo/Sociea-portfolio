        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-12 md:grid-cols-3">
          ...
          <div className="space-y-2 text-white/80 flex flex-col">
            <div className="flex flex-row items-center">
              ...
              <a href="tel:+91 6371130556" className="text-sm sm:text-base">+91 6371130556</a>
            </div>
            <div className="flex flex-row items-center">
              <Mail className="mr-2 h-4 w-4" />
              <a href="mail:sociea.co@gmail.com" className="text-sm sm:text-base">sociea.co@gmail.com</a>
            </div>
          </div>
          ...
          <div className="space-y-3 text-white/80">
            <Link href="#" className="block hover:text-[#1368D6] transition text-sm sm:text-base">
              Privacy policy
            </Link>
            <Link href="#" className="block hover:text-[#1368D6] transition text-sm sm:text-base">
            ...
            <p className="pt-4 sm:pt-6 text-xs sm:text-sm text-white/60">© 2025 by Sociea.</p>
          </div>
        </div>
      </div>
    </footer>
